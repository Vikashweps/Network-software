...
class UsersServiceStub(object):
    """Сервис UsersService (согласно варианту)
    """
    ...
    def __init__(self, channel):
        ...
        self.GetUser = channel.unary_unary(
                ...
                response_deserializer=service__pb2.GetUserResponse.FromString,
                _registered_method=True)
...
class UsersServiceServicer(object):
    ...
    def CreateUser(self, request, context):
        """Unary RPC: создание пользователя
        """
...
def add_UsersServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetUser': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=service__pb2.GetUserResponse.SerializeToString,
            ),
...
class UsersService(object):
    ...
    def GetUser(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            service__pb2.GetUserResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
